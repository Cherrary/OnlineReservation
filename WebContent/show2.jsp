										...
										<TBODY>
											<TR>
												<TD vAlign=top width=90 height=90><A
													href=showDetail?diid=${currentdish.diid} target=_blank>
														<IMG height=80 alt=点击图片查看内容
														src="images/${currentdish.diimage}" width=80 border=0>
												</A></TD>
												<TD vAlign=top>
													<TABLE cellSpacing=1 cellPadding=0 width="100%"
														...
														<TBODY>
															...
															<TR>
																<TD height=21><FONT color=#ff0000>现价：人民币${currentdish.diprice}元</FONT>
																	<BR> ${currentdish.didescribe}</TD>
															</TR>
														</TBODY>
													</TABLE>
												</TD>
